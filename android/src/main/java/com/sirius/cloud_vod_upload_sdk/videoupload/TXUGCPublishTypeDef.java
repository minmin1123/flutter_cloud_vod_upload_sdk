...
import com.sirius.cloud_vod_upload_sdk.videoupload.impl.IUploadResumeController;
...
public class TXUGCPublishTypeDef {
    ...
    public final static class TXPublishParam {
        public String taskId = "";                           //上传任务唯一的id
        /**
    ...
    public interface ITXVideoPublishListener {
         ...
         * 短视频发布开始
         */
        void onPublishStart(String taskId);

        /**
         * Short Video Publishing Progress
         * 短视频发布进度
         */
        void onPublishProgress(String taskId, long uploadBytes, long totalBytes);
