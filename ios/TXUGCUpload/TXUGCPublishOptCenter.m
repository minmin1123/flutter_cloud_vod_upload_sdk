...
- (instancetype)init {
    NSLog(@"samzhan TXUGCPublishOptCenter init ");
    if (self = [super init]) {
...
- (void)prepareUpload:(NSString *)signature
    ...
    NSLog(@"samzhan TXUGCPublishOptCenter prepareUpload, signature  ");
    ...
    [self
        freshDomain:UGC_HOST
         completion:^(int result) {
             NSLog(@"samzhan TXUGCPublishOptCenter reFresh, freshDomain callback");
...
- (void)prepareUploadUGC {
    NSLog(@"samzhan TXUGCPublishOptCenter prepareUploadUGC");
    NSString *reqUrl =
    ...
    [self sendHttpRequest:reqUrl
               ...
               completion:^(NSData *_Nullable data, int errCode) {
                 __strong __typeof(weakSelf) self = weakSelf;
                 if (self) {
                     NSLog(@"samzhan TXUGCPublishOptCenter callback");
...
- (void)parsePrepareUploadRsp:(NSData *)rspData {
    ...
    NSLog(@"samzhan TXUGCPublishOptCenter parsePrepareUploadRsp ");
